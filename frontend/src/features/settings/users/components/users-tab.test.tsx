...
const users: UserListItemDto[] = [
  { id: 'u-1', email: 'an.agent@helpdesk.local', fullName: 'An Agent', isActive: true, roles: [], createdDate: '2026-09-01T00:00:00Z' },
  { id: 'u-2', email: 'binh@helpdesk.local', fullName: 'Bình', isActive: false, roles: [], createdDate: '2026-09-01T00:00:00Z' },
];
