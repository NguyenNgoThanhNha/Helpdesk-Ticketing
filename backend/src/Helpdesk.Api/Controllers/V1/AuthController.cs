using Helpdesk.Application.Features.V1.Auth.Commands.ForgotPassword;
using Helpdesk.Application.Features.V1.Auth.Commands.Login;
using Helpdesk.Application.Features.V1.Auth.Commands.Logout;
using Helpdesk.Application.Features.V1.Auth.Commands.RefreshToken;
using Helpdesk.Application.Features.V1.Auth.Commands.Register;
using Helpdesk.Application.Features.V1.Auth.Commands.ResetPassword;
using Helpdesk.Application.Features.V1.Auth.DTOs;
using Helpdesk.Application.Features.V1.Auth.Queries.GetCurrentUser;
using MediatR;
