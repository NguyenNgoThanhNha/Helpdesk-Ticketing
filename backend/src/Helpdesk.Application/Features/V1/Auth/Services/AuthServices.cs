...
namespace Helpdesk.Application.Features.V1.Auth.Services;
...
public sealed class AuthTokenIssuer(IJwtTokenService jwt, IUnitOfWork<HelpdeskDbContext> unitOfWork, TimeProvider clock)
    : IAuthTokenIssuer
{
