namespace Helpdesk.Application.Features.V1.ApiLogs.DTOs
{
...
namespace Helpdesk.Application.Features.V1.ApiLogs.Queries
{
    ...
    public sealed class SearchApiLogsQueryHandler(IUnitOfWork<HelpdeskDbContext> unitOfWork)
    ...
    public sealed class GetApiLogDetailQueryHandler(IUnitOfWork<HelpdeskDbContext> unitOfWork)
