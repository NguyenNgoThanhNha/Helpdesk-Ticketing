...
namespace Helpdesk.Application.Features.V1.Roles.Commands;
...
{
    public SaveRoleCommandValidator(IUnitOfWork<HelpdeskDbContext> unitOfWork)
    {
...
public sealed class SaveRoleCommandHandler(IUnitOfWork<HelpdeskDbContext> unitOfWork, IPermissionService permissionService)
...
public sealed class DeleteRoleCommandHandler(IUnitOfWork<HelpdeskDbContext> unitOfWork, IPermissionService permissionService)
